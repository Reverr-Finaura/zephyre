            ...
            <div className={style.aboutHero}>
              ...
              <div className={style.aboutHeroRight}>
                ...
                <p className={style.info}>
                  Zephyer Venture Partners is a premier investment management
                  unit specializing in serving the unique needs of Ultra High
                  Net Worth Investors (UHNWI). Headquartered in India, the heart
                  of one of the world's fastest-growing economies, we maintain a
                  global network with partners in major financial hubs
                  worldwide.
                </p>
              </div>
            </div>
